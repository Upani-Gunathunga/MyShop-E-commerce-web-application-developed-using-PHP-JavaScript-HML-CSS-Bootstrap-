...
if (!empty($search)) {
    $query .= "AND `title` LIKE '%" . $search . "%' "; // keep a space after email
            ...
            <div class="card mb-3 mt-3 col-12 col-lg-6">
                <div class="row">
                    <div class="col-md-4 mt-4">
                        ...
                        $profile_img_data = $product_img_rs->fetch_assoc();

                        ?>

                        <img src="<?php echo $profile_img_data["img_path"];  ?>" class="img-fluid rounded-start" />
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
