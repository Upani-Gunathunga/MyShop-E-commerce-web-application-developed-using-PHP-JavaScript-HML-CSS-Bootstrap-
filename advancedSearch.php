                    ...
                    <div class="offset-lg-4 col-12 col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-10 text-center">
                                <P class="fs-1 text-text-danger-emphasis fw-bold mt-3 pt-2 text-lg-start">Advanced Search</P>
                            </div>
                            <div class="col-12">
                    ...
                    <div class=" col-12 ">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 mt-2 mb-1 d-grid">
                                <button class="btn btn-danger" onclick="advancedSearch(0);">Search</button>
                            </div>
                            <div class="col-12">
                                <hr class="border border-3 border-danger">
                            </div>
                    ...
                    <div class="offset-lg-1 col-12 col-lg-10 text-center">
                        <div class="row " id="view_area">
                            ...
                            <div class="offset-3 col-6 mt-3 mb-5">
                                <span class="h1 text-black-50 fw-bold">Search Results will appear here</span>
                            </div>
                        </div>
                    </div>
                </div>
